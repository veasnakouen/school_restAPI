                ...
                @if (mode === 'register') {
                  <div class="grid gap-4 sm:grid-cols-2" @fadeIn>
                    ...
                    <label class="form-control">
                      ...
                      <div class="relative">
                        <input [type]="showPassword ? 'text' : 'password'" formControlName="password" autocomplete="new-password" class="app-input w-full pr-12" placeholder="At least 8 characters" />
                        <button type="button" tabindex="-1" class="btn btn-ghost btn-sm absolute right-2 top-1/2 -translate-y-1/2 text-base-content/50 hover:text-base-content" (click)="togglePasswordVisibility()" aria-label="Toggle password visibility">
                          @if (showPassword) {
                    ...
                    <label class="form-control">
                      ...
                      <div class="relative">
                        <input [type]="showPassword ? 'text' : 'password'" formControlName="confirmPassword" autocomplete="new-password" class="app-input w-full pr-12" placeholder="Repeat password" />
                        <button type="button" tabindex="-1" class="btn btn-ghost btn-sm absolute right-2 top-1/2 -translate-y-1/2 text-base-content/50 hover:text-base-content" (click)="togglePasswordVisibility()" aria-label="Toggle password visibility">
                          @if (showPassword) {
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" /></svg>
                          } @else {
                  ...
                  <div class="space-y-4" @fadeIn>
                    <label class="form-control">
                      <div class="label pb-2">
                        <span class="label-text text-xs font-bold uppercase tracking-[0.3em] text-base-content/55">Email or Username</span>
                      </div>
                      <input type="text" formControlName="email" autocomplete="username" class="app-input" placeholder="you@example.com" />
                    </label>
                    ...
                    <label class="form-control">
                      ...
                      <div class="relative">
                        <input [type]="showPassword ? 'text' : 'password'" formControlName="password" autocomplete="current-password" class="app-input w-full pr-12" placeholder="••••••••" />
                        <button type="button" tabindex="-1" class="btn btn-ghost btn-sm absolute right-2 top-1/2 -translate-y-1/2 text-base-content/50 hover:text-base-content" (click)="togglePasswordVisibility()" aria-label="Toggle password visibility">
                          @if (showPassword) {
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" /></svg>
                          } @else {
